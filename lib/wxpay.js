...
function WXPay() {
    ...
    this.wxtransID = { mch_appid: this.options.appid, mchid: this.options.mch_id };
};
...
WXPay.mix('createTrans', function(opts, fn) {

    opts.nonce_str = opts.nonce_str || util.generateNonceString();
    util.mix(opts, this.wxtransID);
    opts.sign = this.sign(opts);
...
WXPay.mix('queryTrans', function(opts, fn) {
